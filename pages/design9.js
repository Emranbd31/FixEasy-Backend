export default function Design9() {
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', background: '#FFF1F2', minHeight: '100vh' }}>
      {/* Header */}
      <nav style={{ background: 'white', padding: '1.5rem 2rem', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: '700', color: '#E11D48' }}>FixEasy</h1>
          <button style={{ background: '#E11D48', color: 'white', border: 'none', padding: '0.75rem 1.5rem', borderRadius: '8px', fontWeight: '600', cursor: 'pointer' }}>Book Now</button>
        </div>
      </nav>
      ...
      <section style={{ padding: '4rem 2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', background: 'white', borderRadius: '24px', padding: '3rem', boxShadow: '0 8px 32px rgba(0,0,0,0.08)', display: 'flex', alignItems: 'center', gap: '4rem', flexWrap: 'wrap' }}>
          <div style={{ flex: 1, minWidth: '300px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: '800', marginBottom: '1.5rem', color: '#9F1239', lineHeight: '1.2' }}>
              Book Trusted<br />Experts
            </h2>
            <p style={{ fontSize: '1.2rem', color: '#881337', marginBottom: '2rem', lineHeight: '1.6' }}>
              Your home, our responsibility.
            </p>
            <button style={{ background: '#E11D48', color: 'white', border: 'none', padding: '1rem 2.5rem', borderRadius: '12px', fontWeight: '700', fontSize: '1.1rem', boxShadow: '0 4px 16px rgba(225,29,72,0.3)', cursor: 'pointer' }}>
              Book Now
            </button>
          </div>
