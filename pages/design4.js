    ...
    <div style={{ fontFamily: 'system-ui, sans-serif', background: '#FFF7ED', minHeight: '100vh' }}>
      ...
      <nav style={{ background: 'white', padding: '1.5rem 2rem', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: '700', color: '#EA580C' }}>FixEasy</h1>
          <button style={{ background: '#EA580C', color: 'white', border: 'none', padding: '0.75rem 1.5rem', borderRadius: '8px', fontWeight: '600', cursor: 'pointer' }}>Get Started</button>
        </div>
      </nav>
      ...
      <section style={{ padding: '4rem 2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', background: 'white', borderRadius: '24px', padding: '3rem', boxShadow: '0 8px 32px rgba(0,0,0,0.08)', display: 'flex', alignItems: 'center', gap: '4rem', flexWrap: 'wrap' }}>
          <div style={{ flex: 1, minWidth: '300px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: '800', marginBottom: '1.5rem', color: '#9A3412', lineHeight: '1.2' }}>
              Book Instantly,<br />Relax Instantly
            </h2>
            <p style={{ fontSize: '1.2rem', color: '#78350F', marginBottom: '2rem', lineHeight: '1.6' }}>
              Fast, reliable, and secure home services at your fingertips.
            </p>
            <button style={{ background: '#EA580C', color: 'white', border: 'none', padding: '1rem 2.5rem', borderRadius: '12px', fontWeight: '700', fontSize: '1.1rem', boxShadow: '0 4px 16px rgba(234,88,12,0.3)', cursor: 'pointer' }}>
              Get Started
            </button>
          </div>
